...
public class SessionController {
    ...
    public ResponseEntity<Page<SessionResponse>> getSessionsBetweenDates(
        ...
        log.info("REST request to fetch sessions between: {} and {}", startDate, endDate);
        Page<SessionResponse> response = sessionService.getSessionsBetweenDates(startDate, endDate, pageable);
        return ResponseEntity.ok(response);
    }
}
